...
func UpdateButtonLightsAndListsAtStop(floor int) {
...
func HandleButtonPress(button elevio.ButtonEvent) {
	...
	case elevio.BT_HallUp:
		UpdateAndBroadcastPRList(button)
		ReceiveAndUpdatePRListFromElder()
...
func ReceiveAndUpdatePRListFromElder() {
	//elev.PRList = //lytter etter svar fra Elder
	//om timeout: break
}
